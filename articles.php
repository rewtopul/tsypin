<?php
include ('config.php');
$paring = "SELECT * FROM articles";               //Выбрать все статьи из нашей таблицы
$response = mysqli_query($connection, $paring);  // Выводим статьи из базы

//количество статей на странице
//новости на одной странице
$news_page=4;// 4 статьи на с транице

//расчёт страниц по ( id )
...
echo 'Всего страниц:'.$pages_total.'<br>';      // Выводим сообщения
...
// с чего начать показ (нумерация мдёт с нуля)
